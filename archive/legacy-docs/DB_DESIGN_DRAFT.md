...
> 최신 기준 아님.
>
> 이 문서는 2026-05-28 DB 설계 초안과 Supabase v2 migration 맥락을 보존하기 위한 참고용 문서다. 최신 DB 기준은 `DATABASE_SCHEMA.md`를 따른다.
>
> 이 문서 안의 타격권, 나무 타격, 검 강화, 주문서, 검 배율 구조는 최신 MVP 기준에서 폐기 또는 보류한다.
