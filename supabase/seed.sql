...
values
  ...
  ('rare_attendance', 'rare', '성실의 증명',    '모든 출석 배지를 획득했습니다.', '획득 전에는 조건 숨김', 3000,  'rare_attendance', true, true, 31),
  ('rare_quiz',       'rare', '지식의 증명',    '모든 퀴즈 배지를 획득했습니다.', '획득 전에는 조건 숨김', 3000,  'rare_quiz',       true, true, 32),
